...
public final class OriginalConfPretreatmentUtil {
	...
	public static void dealWriteMode(Configuration originalConfig) {
		...
		// 表内需要分片的话需要新增分片字段
		Boolean needSlice = originalConfig.getBool(Key.NEED_SLICE);

		if (needSlice != null && needSlice) {

			String sliceColumnName = originalConfig.getString(Key.SLICE_COLUMN_NAME);
			
			columns.add(sliceColumnName);
			valueHolders.add("?");
		}
